const identity = { name: "Xavi Hart", image: "Profile-pic" };
const data = {
	NavBar: {
		...identity,
		links: [
	...
	Home: {
		introduction:
			"Well-qualified aspiring Full Stack Developer with over 7+ years of experience in Web & Mobile Development. Not only proficient in high quality code and highly responsive UI development using wide range of programing languages, but also brilliant at handling problems in any part of process with ease, especially in React for front end development. Always with customers by going the extra mile to makes them unquestionably satisfied with our product and service",
		resumeLink: "14lX-qsadPSHmpvigs2Yyl5AVYs4bKxQe",
		typedElement: [
			"Xavi Hart",
	...
	About: {
		...
		about: {
			"tech-stats": "Full Stack Web & Mobile Developer",
			bio: "An Enthusiast Coder Eager to contribute to team success through hard work, skills, attention to details and excellent organizational skills. Currently, Exploring the world of Technology as self employed Developer. Formerly worked as Senior Full Stack Developer, Front End Develoer and E-commerce Developer in 3 companies for 7+ years.",
			"IDE and Editors": [
				"Visual Studio",
				"WebStorm",
				"PHPStorm",
		...
		skills: [
			[
				{ skill: "HTML5/CSS3", progress: "95" },
				{ skill: "SCSS", progress: "90" },
				...
				{ skill: "Firebase, Heroku, AWS, Docker", progress: "90" },
			],
			[
				{ skill: "React", progress: "90" },
				{ skill: "Next.js", progress: "95" },
				{ skill: "Vue", progress: "90" },
				{ skill: "Laravel/Symfony", progress: "85" },
				{ skill: "Node.js / Express / Nest.js ", progress: "85" },
				{
					skill: "MUI/ tailwind CSS/Styled Components",
					progress: "85",
				},
				{
					skill: "Unit / Integration / End-to-End Testing",
					progress: "90",
				},
				{ skill: "Django/Flask", progress: "75" },
			],
		],
		education: [
			{
				...
				college: "University of Manchester, Manchester UK",
				duration: "2011 - 2016",
				percentage: "GPA:3.8",
			},
		],
	...
	Portfolio: [
		{
			...
			project: "Blinq",
			description:
				"The Best Deals on Headphones & Portable Audio (React, Webpack, Shopify, ...)",
			placement: "top",
		},
		{
			animationClass: "slideInUp",
			delay: "0",
			project: "PaySomeoneToDo",
			description:
		...
		},
		{
			...
			project: "Janney",
			description:
				" A full service financial services, wealth management, and capital markets organization with the highest standard of success.",
			placement: "top",
		},
		{
			animationClass: "rotateInUpLeft",
			delay: "0.5s",
			project: "FrankelInsurance",
			description:
		...
		},
		{
			...
			project: "Masimo",
			description:
				"A global medical technology company that develops, manufactures, and markets a variety of noninvasive patient monitoring technologies, and consumer products",
			placement: "bottom",
		},
		{
			...
			project: "FundedNext",
			description:
				"A Bangladesh-origin proprietary trading firm that assists trade enthusiasts with individual funding up to $200,000, backed by a solid strategy",
			placement: "bottom",
		},
	],
	Training: {
		...
		training: [
			[
				...
				},
				{
					...
					description:
						"This course covered all the intuitions and theoretical aspects of PHP and PHP Framework which included all necessary skills.",
	...
	Contact: [
		{
			...
			links: [
				{ type: "tel:", title: "+1-7603505705" },
				{ type: "tel:", title: "+1-8076331756" },
			],
		},
		{
			...
			links: [{ type: "mailto:", title: "realdev428@gmail.com" }],
		},
	],
	Social: [
		[
			{
				link: "https://github.com/robinsondev428/",
				class: "fab fa-github",
				name: "GitHub",
				placement: "left",
			},
	...
	Footer: {
		dev: { name: "dev", link: "https://dev.to/", image: "monkey" },
		citation: {
			...identity,
